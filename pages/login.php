...
<body >
  <style>
    body {
 background-image: url("../Spare-Parts-2.jpg");
        ...
        <!-- <div class="card o-hidden border-0 shadow-lg my-5"> -->
          <div class="card-body p-0">
            <!-- Nested Row within Card Body -->
                    ...
                    <h1 class="h4 text-gray-900 mb-4"><span style = "color:white">WELCOME TO SPARE PARTS MANAGEMENT</span></h1>
                    <br>
                    ...
                    <br>
                    <br>
                    <h2 class="h4 text-gray-900 mb-4"><span style = "color:white">Please LOGIN to continue</span></h2>
                  </div>
